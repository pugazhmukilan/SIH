...
class _AnimalSymptomsPageState extends State<AnimalSymptomsPage> {
  ...
  final List<String> symptoms = ['Fever', 'Cough', 'Sneezing', 'Vomiting', 'Diarrhea'];
                ...
                showDialog(
                  ...
                  builder: (context) => AlertDialog(
                    ...
                    content: Column(
                      ...
                      children: animals
                          .where((animal) => animal.toLowerCase().contains(selectedAnimal.toLowerCase()))
                          .map((animal) => ListTile(
                                title: Text(animal),
                                onTap: () {
                                  setState(() {
                    ...
                    child: Container(
                     constraints: BoxConstraints(
                      ...
                      decoration: BoxDecoration(
                        ...
                        color: selectedSymptoms.contains(symptom) ? const Color.fromARGB(255, 0, 82, 55) : const Color.fromARGB(255, 234, 234, 234),
                        borderRadius: BorderRadius.circular(8),
                      ...
                      child: Center(
                        child: Text(
                          symptom,
                          style: TextStyle(
                            color: selectedSymptoms.contains(symptom)? Colors.white :Colors.black,
