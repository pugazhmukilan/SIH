        ...
        home: BlocConsumer<AuthBloc, AuthState>(
          listener: (context, state) {
            ...
            if(state is AutoLoggerNotAvaiable){
              Navigator.pushAndRemoveUntil(context, MaterialPageRoute(builder: (context)=> LoginPage()),(Route<dynamic> route) =>
          ...
          builder: (context, state) {
            if(state is AutoLoggerAvaiable){
              context.read<AuthBloc>().add(FirebaseAuthenticateUser(email: state.email, password: state.password));
            }
